...
bl_info = {
    "name": "Active swap",
    "description": "Iterate active object over selected with shortcuts (ctrl+shift+²: next, ctrl+shift+alt+² : prev, shift+alt+² : deselect active)",
...
swap_key = 'QUOTE'# Qwerty PC keyboard : "ACCENT_GRAVE"
...
class AS_OT_DeselectActive(bpy.types.Operator):
...
class AS_OT_ActiveNext(bpy.types.Operator):
...
class AS_OT_ActivePrev(bpy.types.Operator):
...
def register_keymaps():
    ...
    kmi = km.keymap_items.new("selection.as_active_next", type = swap_key, value = "PRESS", shift = True, ctrl = True)#shift = True
    kmi = km.keymap_items.new("selection.as_active_prev", type = swap_key, value = "PRESS", shift = True, ctrl = True, alt = True)#shift = True, ctrl = True
    kmi = km.keymap_items.new("selection.deselect_active", type = swap_key, value = "PRESS", shift = True, alt = True)#shift = True, alt = True
